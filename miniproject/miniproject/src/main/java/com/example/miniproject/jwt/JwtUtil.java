...
//        BlackList blackList = blackListRepository.findByToken(token);
//        System.out.println("블랙리스트 토큰 : "+ blackList.getToken());
//        System.out.println("클라이언트 토큰 : "+ token);
//
//        if (blackList != null && !blackList.getToken().equals(token)) {
//            return true;
//        }
        try {
